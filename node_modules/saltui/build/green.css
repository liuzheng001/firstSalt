...
.t-badge.badge-corner.badge-no-child.badge-rb .badge-inner {
  -webkit-transform: rotate(-45deg);
          transform: rotate(-45deg);
  top: auto;
  bottom: 9px;
...
.t-badge.badge-corner.badge-no-child.badge-lb .badge-inner {
  top: auto;
  bottom: 9px;
  right: auto;
  left: -15px;
...
.t-badge.badge-corner.badge-no-child.badge-lt .badge-inner {
  -webkit-transform: rotate(-45deg);
          transform: rotate(-45deg);
  right: auto;
  left: -15px;
...
.t-button-secondary {
  background: #fff;
  color: #40b370;
  border: 1px solid rgba(64,179,112,0.6);
}
.hairline .t-button-secondary {
  border: 0.5px solid rgba(64,179,112,0.6);
}
.t-button-secondary:active {
  background: rgba(64,179,112,0.1);
  color: #3daa6a;
  border-color: #40b370;
}
...
.t-city-selector-tab-bar .t-city-selector-tab-active {
  max-width: 120px;
  border-bottom: 2px solid #40b370;
}
...
.t-grid-touchable.t-no-line .t-grid-item:active:before {
  content: " ";
  width: 100%;
  height: 100%;
  top: 0;
...
.t-picker-field-searchpanel {
  position: relative;
  background-color: rgba(0,0,0,0.6);
}
.t-picker-field-searchpanel-inner {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.t-picker-field-searchpanel-search {
  height: 45px;
}
.t-picker-field-searchpanel-content {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.t-picker-field-searchpanel.multiple .t-picker-field-searchpanel-content {
  bottom: 48px;
  bottom: calc(constant(safe-area-inset-bottom) + 48px);
  bottom: calc(env(safe-area-inset-bottom) + 48px);
}
.t-picker-field-searchpanel-header + .t-picker-field-searchpanel-content {
  top: 45px;
}
.t-picker-field-searchpanel-head-bar + .t-picker-field-searchpanel-content {
  top: 46px;
}
.t-picker-field-searchpanel-head-bar {
  position: relative;
  line-height: 45px;
  border-bottom: 1px solid rgba(31,56,88,0.1);
  padding: 0 16px;
...
.hairline .t-picker-field-searchpanel-head-bar {
  border-bottom: 0.5px solid rgba(31,56,88,0.1);
}
.t-picker-field-searchpanel-head-bar-button {
  position: absolute;
  line-height: 45px;
  color: #40b370;
  right: 16px;
...
.t-picker-field-searchpanel-content .t-scroll-view-inner {
  height: 100%;
}
.t-picker-field-searchpanel-footer {
  position: absolute;
  height: 48px;
  left: 0;
  width: 100%;
...
.hairline .t-picker-field-searchpanel-footer {
  border-top: 0.5px solid rgba(31,56,88,0.1);
}
.t-picker-field-searchpanel-footer .t-picker-field-searchpanel-result-summary {
  padding-left: 12px;
  text-align: left;
  overflow: hidden;
  line-height: 48px;
...
.t-picker-field-searchpanel-footer .t-picker-field-searchpanel-result-summary a {
  color: #40b370;
}
.t-picker-field-searchpanel-footer .t-button {
  position: absolute;
  top: 0;
  right: 0;
  border-radius: 0;
...
.t-picker-field-search-empty {
  position: relative;
  height: 100%;
}
.t-picker-field-search-empty-inner {
  position: absolute;
  left: 50%;
  top: 50%;
  -webkit-transform: translate(-50%, -50%);
...
.t-picker-field-search-results {
  padding-bottom: 18px;
}
.t-picker-field-grouping-title {
...
.t-picker-field-grouping-title .t-picker-field-grouping-title-inner {
  font-weight: bold;
  background-color: rgba(31,56,88,0.04);
  color: rgba(31,56,88,0.8);
  line-height: 24px;
...
.t-picker-field-search-result-item {
  position: relative;
  border-bottom: 1px solid rgba(31,56,88,0.1);
  padding: 18px;
  color: rgba(0,0,0,0.8);
}
.hairline .t-picker-field-search-result-item {
  border-bottom: 0.5px solid rgba(31,56,88,0.1);
}
.t-picker-field-search-result-item .t-icon {
  display: block;
  width: 20px;
  height: 20px;
}
.t-picker-field-search-result-item .t-icon.un-checked {
  width: 18px;
  height: 18px;
}
.t-picker-field-search-result-item .t-icon.un-checked svg {
  width: 18px;
  height: 18px;
  border: 1px solid #40b370;
  border-radius: 50%;
...
.hairline .t-picker-field-search-result-item .t-icon.un-checked svg {
  border: 0.5px solid #40b370;
}
.t-picker-field-search-result-item .t-icon svg {
  fill: #40b370;
  width: 20px;
  height: 20px;
}
.t-picker-field-search-result-item-icon {
  display: block;
  position: absolute;
  top: 50%;
  left: 18px;
...
.t-picker-field-search-result-item-icon.t-picker-field-right-icon {
  left: auto;
  right: 18px;
}
.t-picker-field-search-result-item-entry {
  display: block;
  margin-left: 26px;
  line-height: 20px;
}
.t-picker-field-search-result-item-entry.t-picker-field-right-icon {
  margin-left: 0;
  margin-right: 34px;
}
.t-picker-field-grouping-bar {
  position: absolute;
  top: 50%;
  right: -10px;
  width: 38px;
...
.t-picker-field-group {
  display: none;
}
.t-picker-field-avilible-group {
  color: rgba(31,56,88,0.8);
  display: block;
}
.t-picker-field-avilible-group.t-picker-field-active-group {
  color: #40b370;
}
.t-picker-field-grouping-indicator {
  position: absolute;
  width: 46px;
  height: 46px;
  left: -60px;
...
.t-picker-field-grouping-indicator.t-picker-field-grouping-indicator-hide {
  display: none;
}
.t-picker-field-grouping-indicator.t-picker-field-avilible-group {
  color: rgba(31,56,88,0.8);
}
.t-picker-field-grouping-indicator::before {
  content: '.';
  font-size: 0;
  display: block;
  position: absolute;
...
.hairline .t-table-left-fixed .t-table-body {
  border-right: 0.5px solid rgba(31,56,88,0.2);
}
.t-table-right-fixed .t-table-body {
  border-left: 1px solid rgba(31,56,88,0.2);
}
.hairline .t-table-right-fixed .t-table-body {
  border-left: 0.5px solid rgba(31,56,88,0.2);
}
.t-table-row {
  border-bottom: 1px solid rgba(31,56,88,0.2);
...
.t-table.hide-cols-split-line .t-table-header,
.t-table.hide-cols-split-line .t-table-row {
  border-bottom: none;
}
.t-tag-field-tags {
  padding: 12px 9px 0;
...
.t-timeline-header .t-timeline-header-dot.active {
  width: 18px;
  height: 18px;
  border: 2px solid rgba(64,179,112,0.4);
  background-color: #fff;
}
