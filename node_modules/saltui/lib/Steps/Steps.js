...
var Steps = function (_React$Component) {
  ...
  _createClass(Steps, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (_react2.default.Children.count(nextProps.children) !== _react2.default.Children.count(this.props.children)) {
        if (this.props.direction === 'vertical') {
          return;
        }
        ...
        _react2.default.Children.map(children, function (ele, idx) {
          var np = {
            ...
            detailContentFixStyle: {
              marginLeft: !Number.isNaN(-(iws[idx] + _this3.state.tailWidth) * idx) ? -(iws[idx] + _this3.state.tailWidth) * idx : 0,
...
Steps.propTypes = {
  ...
  type: _propTypes2.default.oneOf(['default', 'title-on-top', 'long-desc']),
