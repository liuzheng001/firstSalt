...
var EmployeeField = function (_React$Component) {
  ...
  _createClass(EmployeeField, [{
    ...
    value: function onPickHandler() {
      ...
      if (Ali.contacts) {
        if (Ali.isDingDing) {
          ...
          option.users = this.props.value.map(function (v) {
            return { emplId: v.key, name: v.label, nickNameCn: v.label };
          });
        }
        Ali.contacts.get(option, function (result) {
          if (result && !result.errorCode) {
            _this3.props.onChange((0, _utils.transToValue)(result.results));
          } else {
            Ali.alert({
        ...
        // fall back to dd api
        var t = this;
        window.dd.biz.contact.choose(_extends({}, option, {
    ...
    value: function getReadOnly() {
      var nativeEnabled = this.isNativeEnabled();
      if (!nativeEnabled) {
        return true;
      }
    ...
    key: 'isNativeEnabled',
    value: function isNativeEnabled() {
    ...
    value: function render() {
      ...
      var modifiedTip = this.isNativeEnabled() ? tip : _react2.default.createElement(
        'div',
        null,
        i18n.readOnly,
        tip
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Field2.default, _extends({}, otherProps, {
          labelRight: _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
              'div',
              { className: (0, _classnames3.default)(_Context2.default.prefixClass('employee-field-placeholder-wrapper'), 'needsclick'), onClick: function onClick(e) {
                  t.onPickHandler(e);
                } },
...
EmployeeField.propTypes = {
  ...
  enableNW: _propTypes2.default.bool
};
