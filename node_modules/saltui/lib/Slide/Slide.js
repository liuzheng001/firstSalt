...
var makeTranslate = function makeTransFactory() {
...
var Slide = function (_React$Component) {
  ...
  function Slide(props) {
    ...
    _this._getLength({ fromMount: true });
    return _this;
  }
  ...
  _createClass(Slide, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var t = this;
      var oldChildrenLength = _react2.default.Children.count(prevProps.children);
      var newChildrenLength = _react2.default.Children.count(this.props.children);
    ...
    */
    ...
    key: '_getLength',
    value: function _getLength(_ref) {
      var _ref$fromMount = _ref.fromMount,
          fromMount = _ref$fromMount === undefined ? true : _ref$fromMount;
    ...
    */
    ...
    value: function _getItemReady(offset, noAnimation) {
      ...
      var item = t['item' + targetPosIndex];
