...
var SlotPane = function (_React$Component) {
  ...
  _createClass(SlotPane, [{
    ...
    value: function componentDidMount() {
      ...
      // 获取所有 scroller 的容器
      var slotBody = t.pane.querySelector('.' + _Context2.default.prefixClass('slot-body'));
      ...
      slotBody.addEventListener('iscroll:tap', function (e) {
        ...
        var reg = new RegExp(_Context2.default.prefixClass('slot-item(\\d+)_(\\d+)'));
        var match = reg.exec(className);
        if (match && className.indexOf(_Context2.default.prefixClass('slot-item-active')) === -1) {
    ...
    value: function handleScrollEnd(column) {
      ...
      var scroller = t['scroller' + column].scroller;
    ...
    value: function findItemHeight(slotBody) {
      var t = this;
      if (!t.itemHeight) {
        var newSlotBody = slotBody || t.pane.querySelector('.' + _Context2.default.prefixClass('slot-body'));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { ref: function ref(c) {
            _this2.pane = c;
          }, className: _Context2.default.prefixClass('slot-pane') },
        t.props.columns && t.props.columns.length ? _react2.default.createElement(
          'ul',
          { className: _Context2.default.prefixClass('slot-columns FBH') },
          t.props.columns.map(function (c, i) {
            ...
            return _react2.default.createElement(
              'li',
              { key: 'column' + i, style: style, className: _Context2.default.prefixClass('FB1 FAC') },
              c
            );
          })
        ) : null,
        _react2.default.createElement(
          'div',
          { className: _Context2.default.prefixClass('slot-body FBH FC9 PR') },
              ...
              _react2.default.createElement(
                ...
                m.map(function (n, j) {
                  return _react2.default.createElement(
                    ...
                    {
                      key: 'item' + i + '_' + j,
                      className: (0, _classnames3.default)(_Context2.default.prefixClass('slot-item' + i + '_' + j), _defineProperty({}, _Context2.default.prefixClass('slot-item-active'), j === t.state.selectedIndex[i]))
                    },
                    n.text
                  );
                }),
...
SlotPane.propTypes = {
  ...
  onScrolling: _propTypes2.default.func,
  scrollMod: _propTypes2.default.string,
  columns: _propTypes2.default.array,
  columnsFlex: _propTypes2.default.array
};
