...
Avatar.formatName = function (name, customFilter) {
  var formattedName = name;
  var isEnglishName = /^[A-Za-z,. ]+$/.test(formattedName);
  var defaultNameFilter = function defaultNameFilter(prevName) {
    return prevName.replace(/[()（）\d]/g, '');
  };
  var filter = customFilter || defaultNameFilter;
