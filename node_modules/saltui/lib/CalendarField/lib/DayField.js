...
var DayField = function (_React$Component) {
  ...
  _createClass(DayField, [{
    ...
    value: function makeViewValue() {
      ...
      var defaultDayFormatterMap = {
        day: _util.defaultFormatter.d,
        dayWithSlot: _util.defaultFormatter.d,
        dayWithHalf: _util.defaultFormatter.dt,
        dayWithTime: _util.defaultFormatter.dt
      };
      switch (t.props.type) {
        case 'year':
        ...
        case 'dayWithTime':
          // 格式化日期
          result.start = _uxcoreFormatter2.default.date(result.start, t.props.formatter || defaultDayFormatterMap[t.props.type]);
          result.end = _uxcoreFormatter2.default.date(result.end, t.props.formatter || defaultDayFormatterMap[t.props.type]);
          if (!Number.isNaN(new Date(result.start))) {
