...
function needUpdateSlotValue(prevProps, nextProps) {
  var checkedProps = ['minDate', 'maxDate', 'minuteStep', 'columns', 'value'];
  return (0, _Utils.shouldUpdate)(prevProps, nextProps, checkedProps);
}
exports.default = {
  ...
  needUpdateSlotValue: needUpdateSlotValue
};
