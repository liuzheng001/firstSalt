...
var Datetime = function (_React$Component) {
  ...
  _createClass(Datetime, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var keys = ['columns', 'minDate', 'maxDate', 'value', 'locale', 'columns'];
      if ((0, _Utils.shouldUpdate)(this.props, nextProps, keys)) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_index.Slot, {
        ...
        cancelText: props.cancelText || _index.locale[props.locale].cancelText,
...
Datetime.needUpdateSlotValue = _index.needUpdateSlotValue;
