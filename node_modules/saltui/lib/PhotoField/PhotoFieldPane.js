...
var PhotoFieldPane = function (_React$Component) {
  ...
  _createClass(PhotoFieldPane, [{
    ...
    value: function renderPhotoList() {
      ...
      var shouldHide = photoItem.length === 0 && files.length === 0;
      if (shouldHide) return null;
      var list = _react2.default.createElement(
        'div',
        {
          className: (0, _classnames5.default)((0, _Context.prefixClass)('photo-list'), {}),
          ref: function ref(c) {
            _this3.list = c;
          }
        },
    ...
    value: function renderPlaceholder() {
      ...
      if (t.props.maxUpload) {
        return _react2.default.createElement(
          'div',
          {
            className: (0, _classnames5.default)((0, _Context.prefixClass)('omit photo-field-placeholder'), _defineProperty({}, (0, _Context.prefixClass)('hide'), t.props.readOnly))
          },
          t.props.placeholder,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          className: (0, _classnames5.default)((0, _Context.prefixClass)('photo-field'), (_classnames2 = {}, _defineProperty(_classnames2, t.props.className, !!t.props.className), _defineProperty(_classnames2, (0, _Context.prefixClass)('hide'), t.props.hide), _defineProperty(_classnames2, 'readOnly', t.props.readOnly), _classnames2))
        },
        _react2.default.createElement(
          _Field2.default,
          {
            ...
            labelRight: _react2.default.createElement(
              'div',
              { className: (0, _classnames5.default)((0, _Context.prefixClass)('photo-field-label-right')) },
              t.renderPlaceholder(),
              !t.props.readOnly ? _react2.default.createElement(_Photo2.default, {
                ...
                className: (0, _classnames5.default)((0, _Context.prefixClass)('photo-upload-icon'), _defineProperty({}, (0, _Context.prefixClass)('photo-upload-icon__disabled'), t.isUploadDisabled())),
                ref: function ref(c) {
                  _this4.uploadIcon = c;
                },
                fill: t.props.fill,
