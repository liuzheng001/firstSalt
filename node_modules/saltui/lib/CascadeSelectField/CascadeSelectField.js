...
function parseProps(props) {
  ...
  var value = (0, _cloneDeep2.default)(props.value || []);
  var cursor = options;
  var newOptions = [];
  ...
  var _loop = function _loop(deep) {
    var index = 0;
    newOptions[deep] = cursor.map(function (o, i) {
      var option = {
        value: o.value,
        text: o.label
      };
...
function parseState(value, options) {
  ...
  var _loop2 = function _loop2(deep) {
    ...
    if (!valueIsFound) {
      var _newOptions$deep = _slicedToArray(newOptions[deep], 1);

      newValue[deep] = _newOptions$deep[0];
    }
    cursor = cursor[index] ? cursor[index].children : null;
  };
...
var CascadeSelectField = function (_React$Component) {
  ...
  _createClass(CascadeSelectField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if ((0, _Utils.shouldUpdate)(this.props, nextProps, ['readOnly', 'options', 'value'])) {
        var t = this;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Popup2.default, {
          content: _react2.default.createElement(_CascadeTab2.default, {
            title: t.props.label,
            locale: t.props.locale,
            confirmText: t.props.confirmText || _i18n2.default[t.props.locale].confirmText,
            cancelText: t.props.cancelText || _i18n2.default[t.props.locale].cancelText,
