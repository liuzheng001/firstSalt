...
var PickerField = function (_React$Component) {
  ...
  _createClass(PickerField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if ((0, _Utils.shouldUpdate)(this.props, nextProps, ['value'])) {
        var t = this;
    ...
    value: function renderResult() {
      ...
      if (this.props.multiple) {
        return this.state.confirmedValue.map(function (value) {
          return _this2.props.formatter(value, _utils2.default.FORMATTER_TYPES.LABEL_FORMATTER);
        }).join('；');
      }
      return this.props.formatter(this.state.confirmedValue[0], _utils2.default.FORMATTER_TYPES.LABEL_FORMATTER);
    }
  }, {
    key: 'renderIcon',
    ...
    value: function render() {
      ...
      var panelProps = {
        ...
        confirmText: t.props.confirmText || _i18n2.default[t.props.locale].confirm,
        onConfirm: function onConfirm(value) {
          if (t.isConfirmLocked) return;
          t.isConfirmLocked = true;
          t.confirmTimer = setTimeout(function () {
        ...
        searchPlaceholder: t.props.searchPlaceholder || _i18n2.default[t.props.locale].searchPlaceholder,
        searchNotFoundContent: t.props.searchNotFoundContent || _i18n2.default[t.props.locale].noData,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            className: _Context2.default.prefixClass('picker-field-content')
          },
          !t.state.confirmedValue[0] ? _react2.default.createElement(
            ...
            t.props.placeholder || _i18n2.default[t.props.locale].placeholder
          ) : '',
          t.state.confirmedValue[0] ? _react2.default.createElement(
            'div',
        ...
        _react2.default.createElement(_Popup2.default, { stopBodyScrolling: false, visible: this.state.popupVisible, animationType: 'slide-left', content: _react2.default.createElement(_SearchPanel2.default, panelProps) })
      );
    }
  }]);
