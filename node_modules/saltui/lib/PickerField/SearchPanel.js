      ...
      if (t.props.fetchUrl) {
        ...
        if (!t.searchIndex) {
          var processFunc = function processFunc(value) {
            ...
            return [t.props.formatter(value, _utils2.default.FORMATTER_TYPES.OPTION_FORMATTER).toString().toLowerCase(), phonetic.join('').toLowerCase(), phonetic.map(function (str) {
              return str[0] || '';
            }).join('').toLowerCase()];
          };
    ...
    value: function renderResultItem(item, index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          t.props.formatter(item, _utils2.default.FORMATTER_TYPES.OPTION_FORMATTER)
        )
      );
    }
  }, {
          ...
          multiple ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: 'javacript:;' },
                t.props.resultFormatter ? t.props.resultFormatter(this.state.value) : _i18n2.default[locale].selected(length)
              )
            )
          ) : null
        ),
        _react2.default.createElement(_Popup2.default, { stopBodyScrolling: false, content: _react2.default.createElement(_SearchResult2.default, resultProps), animationType: 'slide-left', visible: this.state.popupVisible })
      );
    }
  }]);
