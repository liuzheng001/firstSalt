...
var CitySelectField = function (_Component) {
  ...
  _createClass(CitySelectField, null, [{
    key: 'initData',
    value: function initData(props) {
      var districtData = props.districtData,
          selectorType = props.selectorType,
          mode = props.mode,
          value = props.value;

      var data = (0, _utils.clearChildren)(districtData, selectorType);
      if (mode === 'picker') {
        switch (selectorType) {
          case 'province':
            break;
  ...
  function CitySelectField(props) {
    ...
    _this.state = CitySelectField.initData(props);
    return _this;
  }
  ...
  _createClass(CitySelectField, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if ((0, _Utils.shouldUpdate)(this.props, nextProps, ['districtData', 'selectorType', 'mode', 'value'])) {
